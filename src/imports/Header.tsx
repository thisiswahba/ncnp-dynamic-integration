import svgPaths from "./svg-y0rt8p6jb8";
  ...
  return (
    <div className="absolute inset-[34.38%_21.88%_34.38%_21.87%]" data-name="elements">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.99992 4.99999">
        <g>
          <path d={svgPaths.p6452500} fill="var(--fill-0, #161616)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Elements4() {
  return (
    <div className="absolute inset-[34.38%_21.88%_34.38%_21.87%]" data-name="elements">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.2499 6.24999">
        <g>
          <path d={svgPaths.p7845e00} fill="var(--fill-0, #161616)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[58px] relative shrink-0 w-[134.316px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 134.316 58">
        <g clipPath="url(#clip0_131_1614)" id="Logo">
...
function NavHeaderNew() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[70px] items-end justify-between px-[32px] py-[7px] relative" data-name="Nav Header New">
...
export default function Header() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Header">
